...
## Project Structure
    ...
    ├── testapiautostorybo_123700  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_123700`
...
2. Clone this repo and `cd testapiautostorybo_123700`
